...
function Bill () {
  return (
    <div className='h-full md:w-1/3 mob:mt-4 max-w-3xl container  mx-auto p-3  bg-white flex flex-col md:items-top '>
      <h1 className='font-semibold text-black-500 text-lg text-left'>Bill Details</h1>
      ...
      <div className='justify-between flex flex-row ml-1 mr-1 md:ml-0'>
        <p className='font-semibold text-black-500 text-md'>To Pay</p>
        <p className=' font-semibold text-black-500 text-md'>₹420</p>
      </div>
    </div>
  )
}
