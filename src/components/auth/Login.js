...
function Login() {
  ...
  return (
    <div className="w-4/5 max-w-sm mt-10 container mx-auto p-5 bg-white rounded-xl shadow-md   space-x-4 flex flex-col ...">
      <h1 className="text-center text-2xl font-medium text-black p-6">Sign-In</h1>
      ...
      <p className="text-center mt-3">Don't have an account? <span className="text-blue-500 cursor-pointer" onClick={directToSignUp}><strong>Sign up</strong></span></p>
    </div>
  )
}
