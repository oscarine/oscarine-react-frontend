    ...
    <div className="w-4/5 max-w-sm mt-10 container mx-auto p-5 bg-white rounded-xl shadow-md  space-x-4 flex flex-col ...">
      <h1 className="text-center text-2xl font-medium text-black p-6">Sign-Up</h1>
        <form className="flex flex-col ..."> 
          <h5 className="text-m font-medium text-black pb-2 pt-2">Name</h5>
          ...
          <h5 className="text-m font-medium text-black pb-2 pt-2">E-mail</h5>
          <input className="pl-2 pr-2 h-8 rounded-md shadow-md border border-gray-300 focus:outline-none focus:ring-1 focus:ring-black focus:border-transparent ..." type="text" />
          <h5 className="text-m font-medium text-black pb-2 pt-2">Mobile Number</h5>
          <input className="pl-2 pr-2 h-8 rounded-md shadow-md border border-gray-300 focus:outline-none focus:ring-1 focus:ring-black focus:border-transparent ..." type="text" />
          <h5 className="text-m font-medium text-black pb-2 pt-2">Password</h5>
