...
function Search() {
  return (
    <div className="pl-2 pr-2 pt-4 md:pl-6 md:pr-6 md:pt-10">
      <div className="flex justify-between w-11/12 max-w-4xl m-auto items-center relative">
        <input className="pl-10 md:pl-16 pr-6 h-10 md:h-16 mr-6 md:mr-12 md:text-2xl items-center w-full  rounded-lg shadow-md border border-gray-300 focus:outline-none " type="text" placeholder="Search For Shops Or Items"/>
