...
function Shop () {
  return (
    <Link to='/shop-view' className=' mt-0 md:mt-5 lg:w-64  container mx-auto p-4 bg-white rounded-xl border hover:border-gray-300  flex flex-row md:flex-col  place-items-center md:transform hover:scale-105 ease-in-out duration-500'>
